...
echo "= ubuntu1 ========================================================================"
vagrant up ubuntu1
vagrant ssh ubuntu1 -c "sudo /scripts/pke-multi-master1.sh '$KUBERNETES_VERSION' '192.168.64.12:6443'"
...
echo "= ubuntu2 ========================================================================"
vagrant up ubuntu2
vagrant ssh ubuntu2 -c "sudo /scripts/pke-multi-mastern.sh '$KUBERNETES_VERSION' '192.168.64.12:6443' '$TOKEN' '$CERTHASH' 192.168.64.12"

# install third master node
echo ""
echo "= ubuntu3 ========================================================================"
vagrant up ubuntu3
vagrant ssh ubuntu3 -c "sudo /scripts/pke-multi-mastern.sh '$KUBERNETES_VERSION' '192.168.64.12:6443' '$TOKEN' '$CERTHASH' 192.168.64.13"

# install worker node
echo ""
echo "= ubuntu4 ========================================================================"
vagrant up ubuntu4
vagrant ssh ubuntu4 -c "sudo /scripts/pke-multi-worker.sh '$KUBERNETES_VERSION' '192.168.64.12:6443' '$TOKEN' '$CERTHASH'"
