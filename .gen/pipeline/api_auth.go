...
*/
func (a *AuthApiService) CreateToken(ctx _context.Context, tokenCreateRequest TokenCreateRequest) (TokenCreateResponse, *_nethttp.Response, error) {
	var (
	...
	// body params
	localVarPostBody = &tokenCreateRequest
...
*/
func (a *AuthApiService) DeleteToken(ctx _context.Context, tokenId string) (*_nethttp.Response, error) {
	var (
...
/*
ListTokens List all API tokens
List all API tokens
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return []TokenListResponseItem
*/
func (a *AuthApiService) ListTokens(ctx _context.Context) ([]TokenListResponseItem, *_nethttp.Response, error) {
	var (
